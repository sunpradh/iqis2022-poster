\begin{tikzpicture}[
        ...
        line width=2pt,
        etichetta grafico/.style = {above=0.1cm, font=\small, fill=Grey10, fill opacity=0.9, text opacity=1, rounded corners, inner sep=5pt},
    ...
    \node [etichetta grafico, above=-1.25cm] at (AKLTstate.north east) {AKLT state};
    ...
    \node[etichetta grafico] at (VarBeta.north)
        {\textbf{QFI density ~vs~ $\bm{\beta}$}};

    % Grafici QFI nella fase Haldane e beta=1
    \node[right=1cm of VarBeta.north east, anchor=north west, sfondo grafico]
        (Haldane) {\input{figures/blbq_scaling_haldane.tex} };
    \node[right=1cm of Haldane.north east, anchor=north west, sfondo grafico]

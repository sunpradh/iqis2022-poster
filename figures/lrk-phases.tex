\begin{tikzpicture}[
    ...
    % energy plots
    \node[anchor=west] (DiracSpec) at (-5, -2.5) {\FrameImg{0.8}{figures/lrk_dirac_spectrum.pdf}};
    \node[anchor=west] (MajSpec) at (0, -2.5) {\FrameImg{0.8}{figures/lrk_majorana_spectrum.pdf}};
    ...
    \node (trivial) [below=2cm of DiracSpec, anchor=north] {\input{figures/kitaev-chain-triv.tex}};
